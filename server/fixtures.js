if ( Meteor.users.find().count() === 0 ) {
  Accounts.createUser({
    ...
    password: '12345678',
    profile: {location: {lat: 22.280796, lng: 114.131592, updatedAt: Date.now()}, firstName: "Stephen", lastName: "Parker", destination: "Wanchai"}
  });
  Accounts.createUser({
  ...
  Accounts.createUser({
    ...
    password: '12345678',
    profile: {location: {lat: 22.261575, lng: 114.129661, updatedAt: Date.now()}, firstName: "Patrick", lastName: "Bateman",destination: "Wanchai"}
  });
};